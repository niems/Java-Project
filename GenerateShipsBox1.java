...
public class GenerateShipsbox extends JDialog implements ActionListener{
    ...
    public GenerateShipsBox(Frame owner, boolean modal)
    {
    ...
    public class ShipCreationFrame extends JFrame{
        
        GenerateShipsBox generateShipsBox = new GenerateShipsBox(this,false);
        public GenerateShipsBox(String title)
        {
            super(title);
            init();
        }
